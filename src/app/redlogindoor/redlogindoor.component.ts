...
@Component({
  selector: 'app-redlogindoor',
  templateUrl: './redlogindoor.component.html',
  styleUrls: ['./redlogindoor.component.css']
})
export class RedLoginDoor98456Component implements OnInit {
